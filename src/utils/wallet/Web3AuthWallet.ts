...
import type { CreateConnectorFn, Connector } from '@wagmi/core';
import {
  createConnector,
...
export class Web3AuthWallet extends EVMWallet<Web3AuthOptions> {
  constructor(config: EVMWalletConfig<Web3AuthOptions> = {}) {
    super(config);
  }
